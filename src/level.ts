import { Scene, ArcFollowCamera, Mesh, Vector3, KeyboardEventTypes, CannonJSPlugin, PointLight, SceneLoader, Color4 } from 'babylonjs';
...
export default class Level {
  //public
  public scene: Scene;
  public _camera: ArcFollowCamera = null;
  public _character: Character = null;
  public _ground: Ground = null;
  ...
  public InitLevel(): void {
    ...
    if (this.env.CONFIG.DEBUG) this.scene.debugLayer.show();
    //this.scene.clearColor = new Color4(0.0, 0.0, 0.0, 1);
    //meshes
    this.loadMeshes();
    //actions
    this.bindActions();
    if (this.env.CONFIG.DEBUG) Helpers.showAxis(7, this.scene);
  }
  /*
